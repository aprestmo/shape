...
if ( ! function_exists( 'shape_comments' ) ) :
/**
...
function shape_comment( $comment, $args, $depth ) {
    ...
    <li class="post pingback">
    	<p><?php _( 'Pingback:', 'shape' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( '(Edit)', 'shape' ), ' ' ); ?></p>
	<?php
			break;
		default;
	?>
...
/**
 * Make images responsive by removing width and height
 * from images inserted via the media panel.
 *
 * @since Shape 1.1
 */
