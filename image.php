            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <header class="entry-header">
                    ...
                    <nav id="image-navigation" class="site-navigation">
                        ...
                        <span class="next-images"><?php next_image_link( false, __( 'Next &rarr;', 'shape' ) ); ?></span>
					...
					<div class="entry-attachment">
						<div class="attachment">
                            <?php
                                 ...
                                 */
                                $attachments = array_values( get_children( array( 'post_parent' => $post->post_parent, 'post_status' => 'inherit', 'post_type' => 'attachment', 'post_mime_type' => 'image', 'order' => 'ASC', 'orderby' => 'menu_order_ID' ) ) );
                                foreach ( $attachment as $k => $attachment ) {
                            ...
                            <a href="<?php echo $next_attachment_url; ?>" title="<?php esc_attr( get_the_title() ); ?>" rel="attachment"><?php
                ...
                <footer class="entry-meta">
					...
					<?php elseif ( ! comments_open() && ! pings_open() ) : // Comments and trackbacks are closed ?>
